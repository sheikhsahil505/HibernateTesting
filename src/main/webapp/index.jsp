             ...
             <div class="card-body p-3 text-center">
               ...
               <div class=" ">
                ...
                <h6 class="text-center" style="color: red">  <%
                 ...
                 <p class="small "><a class="text-white-50" href="./jsp/ForgetPassword.jsp">Forgot password ?</a></p>
               ...
               <div>
                 <p class="mb-0"> Don't have an account? <a href="./jsp/NewRegister.jsp" class="text-white fw-bold">Sign Up</a>
                 </p>
               </div>
