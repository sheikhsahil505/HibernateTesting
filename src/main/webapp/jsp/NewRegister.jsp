...
<script  type="text/javascript" src="./jsp/assets/jquery/jquery-3.6.0.min.js"></script>
...
<body>
  ...
  <form action="saveUser" method="post"  id="myForm"  enctype="multipart/form-data">
        ...
        <div class="row">
                 ...
                 <input type="file" id="profilePicture" name="profilePicture" accept="image/*" required>
                   ...
                   <div class="row col-lg-12">
                       ...
                       <div class="col-lg-4 mb-3">
                           ...
                           <input placeholder="Enter Your Email" type="email" id="txtEmail" name="email" onkeyup="ValidateEmail();" required>
                          <br> <span id="emailError" style="color: red"></span>
                       </div>
                   </div>

                           <h6 class="text-center" style="color: red"><% if (request.getAttribute("error") != null) {
                                     out.println(request.getAttribute("error")); } %></h6>
                      ...
                      <div class="row col-lg-12">
                          <div class="col-lg-4 mb-3">
                              ...
                              <input type="text" placeholder="Enter Your Contact" class="form-control" name="contactNumber" id="contactNumber" id="exampleInputEmail1" onkeyup="ValidateContact();" required>
                          ...
                          <div class="col-lg-4 mb-3">
                              ...
                              <input type="password" name="username" id="conpassword" class="form-control" required>
           ...
           <div class="col-lg-1 mb-3">
               ...
               <input type="text" id="pincode0" name="pincodes" required onblur="validateFirstAddressPincode();">
            ...
            <div class="col-lg-1 mb-3">
                ...
                <input type="text" id="country${addressIndex}" name="countries" required>
                            ...
                            <div class="card-footer text-center">
                                ...
                                <p>
                                    Already have an account? <a href="/JspServlet/index.jsp">Login</a>
                                </p>
                            </div>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                              ...
                              alert("Register Successfully");
                                window.location.href= "/JspServlet/index.jsp";
                             }
                            },
                            processData: false,
                            contentType: false
